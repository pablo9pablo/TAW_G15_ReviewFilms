...
public class MovieEntity {
    ...
    private Set<UserEntity> favoriteUsers = new LinkedHashSet<>();

    @ManyToMany
    @JoinTable(name = "watchlist",
            joinColumns = @JoinColumn(name = "MOVIE_ID"),
            inverseJoinColumns = @JoinColumn(name = "USER_ID"))
    private Set<UserEntity> watchlistUsers = new LinkedHashSet<>();

    @ManyToMany
    @JoinTable(name = "seen",
            joinColumns = @JoinColumn(name = "MOVIE_ID"),
            inverseJoinColumns = @JoinColumn(name = "USER_ID"))
    private Set<UserEntity> seenUsers = new LinkedHashSet<>();
}
